...
const PhotocardDivisi = () => {
    ...
    return (
        <div className="photocard-divisi">
            {activeIndex == 5 ? (
                <div className="photocard" style={{'backgroundColor': photocardData[activeIndex][0].bgcolor, 'margin': '24px auto'}}>
                ...
                <div style={{display: 'flex', margin: '0 auto 24px auto'}}>
                    <div className="photocard" style={{'backgroundColor': photocardData[activeIndex][0].bgcolor, 'margin': '24px 24px 0 auto'}}>
                    ...
                    <div className="photocard" style={{'backgroundColor': photocardData[activeIndex][0].bgcolor, 'margin': '24px auto 0 24px'}}>
